class StudentGroupModel {
  ...
  factory StudentGroupModel.fromJson(Map<String, dynamic> json, String documentId) {
    ...
    final rawName = json['group_name'] as String? ?? json['groupName'] as String? ?? json['name'] as String? ?? json['title'] as String?;
    final gName = (rawName != null && rawName.trim().isNotEmpty) ? rawName.trim() : 'Student Group';
